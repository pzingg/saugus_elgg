...
END;
        ...
        $body .= <<< END
            ...
            <tr>
                ...
                <td><p>
END;
        $body .= display_input_field(array("edit_folder_keywords","","keywords","folder",$folder));
...
// $totalquota = get_field('users','file_quota','ident',$USER->ident);
$totalquota = get_field('users','file_quota','ident',$page_owner);
