...
$run_result = "<h2>" . gettext("Welcome") . "</h2>";
...
if ($news = get_records_sql("SELECT wp.* FROM ".$CFG->prefix."weblog_posts wp
    ...
    $run_result .= "<p>" . run("weblogs:text:process",nl2br(stripslashes($latestnews->body))) . "</p>";
    $run_result .= "</div>";
}
?>