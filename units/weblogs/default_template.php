...
<div class="weblog_posts"><!-- Holds all aspects of a blog post -->
    <div class="entry"><!-- Open class entry -->
        <div class="user"><!-- Open class user -->
            <a href="{{url}}{{username}}/weblog/"><img alt="" src="{{url}}{{username}}/icons/{{usericon}}"/></a><br /><a href="{{url}}{{username}}/weblog/">{{fullname}}</a>
...
END;
    ...
    $template_definition[] = array(
        ...
        'glossary' => array(
            ...
            '{{usericon}}' => gettext('The usericon of the person making the comment, if available')
        )
    );
