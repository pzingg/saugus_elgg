...
END;
    ...
    function editfield_defaults () {
        ...
        */
        ...
        $data['profile:details'][] = array(gettext("Twitter username"),"twitter","twitter");
    ...
    function field_display ($field, $allvalues) {
        ...
        if (sizeof($field) >= 2) {
            ...
            if ((($value->value != "" && $value->value != "blank")) 
                && (run("users:access_level_check", $value->access) || (isset($_SESSION['userid']) && $value->owner == $_SESSION['userid']))) {
                $name = $field[0];
