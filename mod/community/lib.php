    ...
    if ($usertype == "community") {
        ...
        if (defined("context") && context == "profile") {
            ...
            if (run("permissions:check", "profile")) {
                ...
                $PAGE->menu_sub[] = array( 'name' => 'community:edit',
                                           'html' => a_hrefg("{$CFG->wwwroot}_userdetails/?context=profile&amp;profile_id=$page_owner" ,
        ...
        if (defined("context") && (context == "profile" || context == "network")) {
            $PAGE->menu_sub[] = array( 'name' => 'community:requests',
                                           'html' => a_hrefg("{$CFG->wwwroot}_communities/requests.php?profile_id=$page_owner",
        ...
        if (defined("context") && context == "network") {
            ...
            $PAGE->menu_sub[] = array( 'name' => 'community',
                                       'html' => a_hrefg("{$CFG->wwwroot}_communities/?owner=$page_owner" ,
                                                          gettext("Communities"))); 
                            
            $PAGE->menu_sub[] = array( 'name' => 'community:owned',
                                       'html' => a_hrefg("{$CFG->wwwroot}_communities/owned.php?owner=$page_owner" ,
